...
| quay_operator_channel                   | no       |    false    | It is used to set subscription channel for QUAY Operator       |
| quay_registry_hostname                   | no       |    false    | It is used to set hostname for quay-registry          |
| quay_enable_global_secret                    | no       |    false    | #set this for using global role for updating pull spec & podman secret             |
